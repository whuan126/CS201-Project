...
set_target_properties(gtest PROPERTIES
  ...
  INTERFACE_INCLUDE_DIRECTORIES "/root/CS201/CS201-Project/LLVM/llvm/utils/unittest/googletest/include;/root/CS201/CS201-Project/LLVM/llvm/utils/unittest/googlemock/include"
...
set_target_properties(LLVMHello PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/LLVMHello.so"
...
set_target_properties(LLVMTestingSupport PROPERTIES
  ...
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/libLLVMTestingSupport.a"
  )
...
set_target_properties(FileCheck PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/FileCheck"
  )
...
set_target_properties(llvm-PerfectShuffle PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/llvm-PerfectShuffle"
  )
...
set_target_properties(count PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/count"
  )
...
set_target_properties(not PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/not"
  )
...
set_target_properties(yaml-bench PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/yaml-bench"
  )
...
set_target_properties(BugpointPasses PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/BugpointPasses.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(lli-child-target PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/lli-child-target"
  )
...
set_target_properties(llvm-jitlink-executor PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/llvm-jitlink-executor"
  )
...
set_target_properties(obj2yaml PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/obj2yaml"
  )
...
set_target_properties(yaml2obj PROPERTIES
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/bin/yaml2obj"
  )
...
set_target_properties(Bye PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/Bye.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(TestPlugin PROPERTIES
  IMPORTED_COMMON_LANGUAGE_RUNTIME_RELEASE ""
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/unittests/Passes/TestPlugin.so"
  IMPORTED_NO_SONAME_RELEASE "TRUE"
  )
...
set_target_properties(gtest PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/libgtest.a"
  )
...
set_target_properties(gtest_main PROPERTIES
  IMPORTED_LINK_INTERFACE_LANGUAGES_RELEASE "CXX"
  IMPORTED_LOCATION_RELEASE "/root/CS201/CS201-Project/LLVM/build/lib/libgtest_main.a"
  )
